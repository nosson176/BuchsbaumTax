...
public class Migration {
    ...
    private Handle getHandle() {
        try {
            Connection connection = DriverManager.getConnection("jdbc:postgresql://buchsbaumdb.c1w2s6uqe11n.il-central-1.rds.amazonaws.com:5432/buchsbaum", "postgres", "sifra123");
    ...
    public static void main(String[] args) {
       String root = "D:/elyasaf/BuchsbaumTaxProject/Project Files/Project Files/datadump/";
