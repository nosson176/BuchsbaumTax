...
public interface SmartviewDAO {
    ...
    @SqlBatch("UPDATE smartviews SET sort_number = :sortNumber, updated = NOW() WHERE id = :id")
    void updateSmartviewsOrder(@BindBean List<Smartview> smartviews);
