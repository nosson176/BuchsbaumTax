...
public interface FeeDAO {
    ...
    @SqlUpdate("UPDATE fees SET year = :year, status = :status, status_detail = :statusDetail, fee_type = :feeType, manual_amount = :manualAmount, paid_amount = :paidAmount, include = :include, rate = :rate, date_fee = :dateFee, sum = :sum, archived = :archived, notes = :notes WHERE id = :id")
    ...
    @SqlBatch("UPDATE fees SET year = :year, status = :status, status_detail = :statusDetail, fee_type = :feeType, manual_amount = :manualAmount, paid_amount = :paidAmount, include = :include, rate = :rate, date_fee = :dateFee, sum = :sum, archived = :archived WHERE id = :id")
