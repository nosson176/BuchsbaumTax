...
//        this.fbarBreakdowns = Database.dao(FbarBreakdownDAO.class).getForClient(client.getId());
//        this.incomeBreakdowns = Database.dao(IncomeBreakdownDAO.class).getForClient(client.getId());
        this.fbarBreakdowns = Database.dao(FbarBreakdownDAO.class).getFbarBreakdownsFromLastThreeYears(client.getId(),threeYearsAgoStart);
        this.incomeBreakdowns = Database.dao(IncomeBreakdownDAO.class).getIncomeBreakdownsFromLastThreeYears(client.getId(),threeYearsAgoStart);
