...
//        this.incomeBreakdowns = Database.dao(IncomeBreakdownDAO.class).getForClient(client.getId());
        this.fbarBreakdowns = Database.dao(FbarBreakdownDAO.class).getNewestFbarBreakdowns(client.getId());
        this.incomeBreakdowns = Database.dao(IncomeBreakdownDAO.class).getNewestIncomeBreakdowns(client.getId());
        this.logs = Database.dao(LogDAO.class).getNewestLogs(client.getId());
