...
public class BuchsbaumApplication extends SifraApplication {
    ...
    public BuchsbaumApplication() {
        ...
        DatabaseConfig.Connection connection = new DatabaseConfig.Connection("jdbc/BTDB", "jdbc:postgresql://buchsbaumdb.c1w2s6uqe11n.il-central-1.rds.amazonaws.com:5432/buchsbaum", "postgres", "sifra123");
